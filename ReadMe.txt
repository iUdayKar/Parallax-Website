...
& to be honest I learned a lot while working on this project,
I created this webpage using HTML & CSS & also used some images that I found on Google, 
& some similar sites from which we can download images.
